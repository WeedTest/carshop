...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mixins\Stringable::thousand()
         * @param string $separator
         * @return \Illuminate\Support\Stringable 
         * @static 
         */ 
        public static function thousand($separator = ' ')
        {
                        return \Illuminate\Support\Stringable::thousand($separator);
        }
                    /**
         * 
         *
         * @see \App\Mixins\Stringable::spacer()
         * @param mixed $values
         * @return \Illuminate\Support\Stringable 
         * @static 
         */ 
        public static function spacer(...$values)
        {
                        return \Illuminate\Support\Stringable::spacer(...$values);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Mixins\Blueprint::slug()
         * @return \Illuminate\Database\Schema\ColumnDefinition 
         * @static 
         */ 
        public static function slug()
        {
                        return \Illuminate\Database\Schema\Blueprint::slug();
        }
